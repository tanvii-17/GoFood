                ...
                <div className="carousel-inner " id='carousel'>
                    <div class=" carousel-caption  " style={{ zIndex: "9" }}>
                        <form className=" d-flex justify-content-center">  {/* justify-content-center, copy this <form> from navbar for search box */}
                            ...
                            <button className="btn text-white bg-success text-white bg-success" type="submit">Search</button>
                        </form>
                    </div>
                    ...
                    <div className="carousel-item">
                        <img src="https://source.unsplash.com/random/900x700/?chinese" className="d-block w-100 " style={{ filter: "brightness(30%)" }} alt="..." />
                    </div>
                    <div className="carousel-item">
                        <img src="https://source.unsplash.com/random/900x700/?pulav" className="d-block w-100 " style={{ filter: "brightness(30%)" }} alt="..." />
                    </div>
                </div>
